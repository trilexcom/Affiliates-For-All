...
class Database {
    public static $order_fields = 'id*, affiliate*, status*,
        customer_name, customer_email, total*, commission*, date_entered*';
    public static $order_headings = 'Order Number, Affiliate, Status,
        Customer Name, Customer Email, Total, Commission, Order Date';
    public static $order_sizes = '15, 8, 8, 20, 20, 6, 6, 10';
